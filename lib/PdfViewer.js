...
var entry_webpack = require('react-pdf/dist/esm/entry.webpack');
...
var ChevronUpCircle = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
...
var Gallery = function Gallery(_ref) {
  ...
  useStyles$1(); // We only have 3 images, but we paginate them absolutely (ie 1, 2, 3, 4, 5...) and
...
var toolsStyles = styles.makeStyles(function (theme) {
  return {
    tools: {
      position: 'absolute',
      bottom: 0,
    ...
    arrows: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'space-between' // width: theme.spacing(10)
...
function Tools(_ref) {
  ...
  React.useEffect(function () {
    if (gaCategory) {
      GA.event(gaCategory, "".concat(show ? 'Opened' : 'Closed', " Full Screen Tools"));
    }
  }, [show]);
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(core$1.Button, {
    size: "small",
    color: "secondary",
    className: cx__default['default'](classes.btn, classes.marginRight),
    onClick: onExit
  }, /*#__PURE__*/React__default['default'].createElement(core$1.Typography, {
    className: classes.btnTxt
  }, "Exit"), ' ', /*#__PURE__*/React__default['default'].createElement(FullscreenExit, {
    size: 24,
  ...
  }, /*#__PURE__*/React__default['default'].createElement(ChevronUpCircle, {
    size: 36,
    className: classes.chveron
  }))));
}

function PdfViewer(_ref2) {
  var file = _ref2.file,
      gaCategory = _ref2.gaCategory;
  ...
  var pageViewStartTime = React.useRef(new Date().getTime());
  ...
  function GoFullScreenBtn() {
    return /*#__PURE__*/React__default['default'].createElement(core$1.Button, {
      className: classes.fullScreenBtn,
      size: "small",
      onClick: function onClick() {
        setFullScreen(true);
      }
    }, "Full Screen ", /*#__PURE__*/React__default['default'].createElement(Expand, {
      size: 18,
  ...
  React.useEffect(function () {
    ...
    var timeSpent = (pageViewStartTime - timestamp) / 1000;

    if (timeSpent >= 2 && gaCategory) {
      GA.event(gaCategory, "time spent on slide ".concat(slide), timeSpent);
    }
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(entry_webpack.Document, {
    file: file,
    ...
    forceControls: true,
    forceIndex: slide,
    onItemWidthChange: function onItemWidthChange(width) {
      setWidth(width - 2);
    },
    onChange: setSlide
  }, _toConsumableArray$1(Array(numPages)).map(function (j, i) {
    return /*#__PURE__*/React__default['default'].createElement(entry_webpack.Page, {
      key: i,
      className: classes.canvas,
      pageNumber: i + 1,
      width: width
    });
  })), /*#__PURE__*/React__default['default'].createElement(GoFullScreenBtn, null)), /*#__PURE__*/React__default['default'].createElement(framerMotion.AnimatePresence, null, fullScreen && /*#__PURE__*/React__default['default'].createElement(framerMotion.motion.div, {
    className: cx__default['default'](classes.backdrop),
    initial: {
      opacity: 0
