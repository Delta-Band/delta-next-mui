...
var ChevronDown$1 = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "none",
...
function DeltaAccordion(_ref) {
  ...
  function AccordionItem(_ref2) {
    ...
    return /*#__PURE__*/React__default.createElement(Accordion, null, /*#__PURE__*/React__default.createElement(AccordionSummary, {
      expandIcon: /*#__PURE__*/React__default.createElement(ChevronDown, {
        size: 24
      }),
      className: cx(_defineProperty$1({}, classes.subItemSummary, isSubItem))
    }, item.summary), /*#__PURE__*/React__default.createElement(AccordionDetails // className={cx({ [classes.subItemDetails]: isSubItem })}
    , null, item.details));
  }
  ...
  function structure(item, _key, isSubItem) {
    if (Array.isArray(item.details)) {
      ...
      }, item.summary), /*#__PURE__*/React__default.createElement(AccordionDetails, {
...
export { DeltaAccordion as Accordion, ScrollDownTip };
