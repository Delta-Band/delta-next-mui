...
function Carousel(_ref2) {
  ...
  React.useEffect(function () {
    ...
    docBody.current = document.body; // myRef.current.addEventListener('touchstart', onTouchStart, true);
  ...
  })), (upMd || forceControls) && /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, leftControll || /*#__PURE__*/React__default['default'].createElement(ArrowLeft, {
    size: 32
  }))), /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(framerMotion.motion.div, {
    variants: MOTION_VARIANTS.btn,
    className: classes.btn,
  ...
  }, rightControll || /*#__PURE__*/React__default['default'].createElement(ArrowRight, {
    size: 32
  })))));
}
...
var useStyles$1 = styles.makeStyles(function (theme) {
  return {
    screenCover: {
      ...
      height: '100%',
      width: '100vw',
      backgroundColor: colorManipulator.fade(theme.palette.primary.dark, 0.5),
...
function DeltaModal(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Portal, null, /*#__PURE__*/React__default['default'].createElement(framerMotion.AnimatePresence, null, show && /*#__PURE__*/React__default['default'].createElement("div", null, "Hello") // <motion.div
...
var Gallery = function Gallery(_ref) {
  ...
  useStyles(); // We only have 3 images, but we paginate them absolutely (ie 1, 2, 3, 4, 5...) and
  // then wrap that within 0-2 to find our image ID in the array below. By passing an
  // absolute page index as the `motion` component's `key` prop, `AnimatePresence` will
  // detect it as an entirely new image. So you can infinitely paginate as few as 1 images.

  var imageIndex = infinte ? popmotion.wrap(0, children.length, page) : page;
