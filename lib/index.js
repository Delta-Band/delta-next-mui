...
var ChevronDown$1 = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "none",
...
ChevronDown$1.displayName = 'ChevronDown';
...
var useStyles$1 = styles.makeStyles(function (theme) {
  ...
  return {
    scrollTipRoot: (_scrollTipRoot = {
      ...
      top: 'calc(100vh - 50px)',
      left: '50%'
    }, _defineProperty$1(_scrollTipRoot, theme.breakpoints.up('sm'), {}), _defineProperty$1(_scrollTipRoot, theme.breakpoints.up('md'), {
      top: 'calc(100vh - 30px)'
    }), _defineProperty$1(_scrollTipRoot, theme.breakpoints.up('lg'), {}), _defineProperty$1(_scrollTipRoot, theme.breakpoints.up('xl'), {
...
function DeltaAccordion(_ref) {
  ...
  function AccordionItem(_ref2) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Accordion, null, /*#__PURE__*/React__default['default'].createElement(AccordionSummary, {
      expandIcon: /*#__PURE__*/React__default['default'].createElement(ChevronDown, {
        size: 24
      }),
      className: cx__default['default'](_defineProperty$1({}, classes.subItemSummary, isSubItem))
    }, item.summary), /*#__PURE__*/React__default['default'].createElement(AccordionDetails // className={cx({ [classes.subItemDetails]: isSubItem })}
    , null, item.details));
  }
  ...
  function structure(item, _key, isSubItem) {
    if (Array.isArray(item.details)) {
      ...
      }, item.summary), /*#__PURE__*/React__default['default'].createElement(AccordionDetails, {
        className: classes.subAccordion
      }, item.details.map(function (subItem, j) {
        return structure(subItem, "".concat(_key, "-").concat(j));
      })));
    } else {
